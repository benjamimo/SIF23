...
# ╔═╡ 2747c3de-401c-4a2a-8602-d5470d566c9f
using Plots

# ╔═╡ 8ceb6426-98d1-11ed-36a3-1b86586c0fbb
md"""
...
# ╔═╡ bbfbe8ec-a2d1-4134-9b03-27272acd05b5
md"""
## ¿Qué es Pluto?
...
# ╔═╡ 889ef941-1071-46cb-b281-faa26fc4dd9d
md"""
## Reactividad
...
# ╔═╡ a0bacec5-19da-47f6-8931-ff78a4b8e66e
a = 1
...
# ╔═╡ b1f0d506-f74d-4228-bbd3-921f7ed19402
md"
### Sliders
...
# ╔═╡ 3a1a6737-c015-4909-826d-1551e1f15de0
@bind sliderA Slider(0:10, 5, true)

# ╔═╡ 1f124581-5058-4615-a0fb-781ac7125e3e
sliderA + 10

# ╔═╡ 408fc40c-2b21-4651-beb6-cc1da2299b5c
md"
Para múltiples sliders usaremos el símbolo $ dentro del entorno de md.
"

# ╔═╡ 157c3368-ceeb-4c7b-a40c-c4818fc82ff8
md"
...
# ╔═╡ 2ea38fb6-2af7-4717-8fb8-d390117ef712
sliderB+sliderC

# ╔═╡ 3d8185d3-56e6-4dbe-9a9f-83558cacfb44
md"
### Scrubable
...
# ╔═╡ 78d0632c-f6c7-41a1-a3f3-de8a7d2a54a9
@bind scrubD Scrubbable(0:10, default=5)

# ╔═╡ 13f58614-f5e4-49d1-aea6-14fbba95c97b
md"
### Number field
...
# ╔═╡ b54a23b1-4e41-4ca6-b21d-991f45947a81
@bind numeroE NumberField(-5:5, default=1)

# ╔═╡ beefdc0f-c358-45cc-a3b7-f68684c0de03
2*numeroE

# ╔═╡ 299f76e9-2713-4bb9-b9b4-9e37f28d8bbe
md"
### TextField
...
# ╔═╡ 0b64d9c8-184e-4923-a8eb-e8a13a12b767
@bind textF TextField()	

# ╔═╡ aded735b-0eee-4816-aabd-fed5cd544fa1
textF

# ╔═╡ 32609115-8ef2-4708-824e-c2d75304abb5
@bind numeroG TextField()	

# ╔═╡ 34a42b71-4b5e-4c90-8711-c2450bbd7705
numeroG # Esta es una variable tipo char

# ╔═╡ 25ef358d-587e-4e71-a8f3-6046c088c4ae
parse(Float64, numeroG)

# ╔═╡ 233ebf61-d790-4cba-aecb-d460f590ff0c
md"
### CheckBox
...
# ╔═╡ 6036890e-b1fb-4287-a708-81a9a2166ce4
md"
Palomeamos el cuadro $(@bind checkG CheckBox())
"

# ╔═╡ 42ee95db-8f9f-4f78-ac81-a2908db3c517
checkG

# ╔═╡ 4ad67eff-c1bb-4e7d-995d-022d035b0ef4
md"""
### Button

La sintaxis es:
```
@bind buttonH Button("TEXTO")
```
"""

# ╔═╡ a5868a55-47c4-4987-bf62-fd73c73a5f73
@bind buttonH Button("Botón")

# ╔═╡ bf733f52-73b6-4ce3-b3e0-ddca34be9517
buttonH

# ╔═╡ 85502e63-48d6-4f48-aba2-41cf13fc7b8f
begin
	buttonH
	rand()
end

# ╔═╡ 6ed4a536-3b19-42fe-9d25-b701e3ea7cff
md"""
### Clock
...
# ╔═╡ 6225e9cb-d3bd-484a-ad57-22438e61f368
@bind t Clock()

# ╔═╡ 05fce8ca-7c4d-4c8a-9410-c5dffef669d0
deltaT = 1/10

# ╔═╡ e9f9c8d6-092a-4365-a58d-6f4f7dd4cbfb
@bind tf Clock(deltaT, true)

# ╔═╡ edc81e0a-81ae-4963-ad43-dde90b20dcda
tf

# ╔═╡ fc50fced-f834-4970-bee8-76c151c2a825
md"""
## Gráficas
...
x0 $(@bind x0 Slider(-5.0:0.1:5.0, 0.0, true))

A0 $(@bind A0 Slider(0.0:0.1:1.0, 1.0, true))

w0 $(@bind w0 Slider(0.1:0.1:2.0, 0.5, true))
"""
...
# ╔═╡ 4b186a90-b7ce-413a-8625-f9dd64d78c5f
g(0,1,1), g(1, 2,1), g(0,1,1)

# ╔═╡ 59007666-4af7-47b4-bbc7-f30d839a3c9a
begin
	# xs = range(-5.0, 5.0, 128)
	plot(xs, g.(xs,1,1))
end

# ╔═╡ 415550e7-24d0-48ff-9c81-dd35dc2dfb2f
begin
	# xs = range(-5.0, 5.0, 128)
	zs = g.(xs.-x0,A0,w0)
...
# ╔═╡ 0b44e7e1-110e-4c0b-9f28-014db74ef5dd
md"""
## Otros ajustes
...
# ╔═╡ adf2be3b-a29c-4c4a-abbd-794e4534b07a
#TableOfContents(title="Contenidos", indent=true, aside=true)

# ╔═╡ b3475ae9-c886-4d4f-879a-e0d0252e29be
md"""
### Ancho de las celdas
...
# ╔═╡ 9624c929-811b-4634-b536-ece7a0461da9
html"<style>
main {
    max-width: NNpx;
}
